...
fingerprint_template = {
    ...
    'OPS.O1':[["NO","NO","NO","NO","NO","NO"]],
    'OPS.O2':[["NO","NO","NO","NO","NO","NO"]],
    'OPS.O3':[["NO","NO","NO","NO","NO","NO"]],
    'OPS.O4':[["NO","NO","NO","NO","NO","NO"]],
    'OPS.O5':[["NO","NO","NO","NO","NO","NO"]],
    'OPS.O6':[["NO","NO","NO","NO","NO","NO"]],
...
def _expand_columns (in_column_names,dataset):
    ...
    for i_in_dataset, row in enumerate(dataset):
        new_row = []
        for j_in_dataset, cell in enumerate(row):
            new_cell = ["NO"]*columns_max_size[j_in_dataset]
